...
func genActivityAnnounce(domain string, objectID string) fedihelper.Activity {
	return fedihelper.Activity{
		"@context": fedihelper.ContextActivityStreams,
		"type":     fedihelper.TypeAnnounce,
...
func genActivityAccept(domain, to, activityID string) fedihelper.Activity {
	return fedihelper.Activity{
		"@context": fedihelper.ContextActivityStreams,
		"type":     fedihelper.TypeAccept,
		"to":       []string{to},
		"actor":    genActorSelf(domain),
		"object": map[string]interface{}{
			"type":   fedihelper.TypeFollow,
			"id":     activityID,
...
func genActivityUndo(domain, to string) fedihelper.Activity {
	return fedihelper.Activity{
		"@context": fedihelper.ContextActivityStreams,
		"type":     fedihelper.TypeUndo,
		"to":       []string{to},
		"actor":    genActorSelf(domain),
		"object": map[string]interface{}{
			"type":   fedihelper.TypeFollow,
